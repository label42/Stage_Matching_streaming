...
```{r}
match_matrix <- as.data.frame(res_match_5to1_re_cali$match.matrix) %>%
...
most_matched <- as.character(match_count$Var1[1:100])

PC18_to_m[most_matched, list_var_match]
...
On s'en sort avec un ESS de 842, ce qui est tout de même asez faible. A discuter.
