...
mean_afm_nostrm <- weighted.mean(PC18_m$nbr_genre_music[PC18_m$stream_spe == 0], PC18_m$POND_m[PC18_m$stream_spe == 0])
mean_afm_strm <- weighted.mean(PC18_m$nbr_genre_music[PC18_m$stream_spe == 1], PC18_m$POND_m[PC18_m$stream_spe == 1])
