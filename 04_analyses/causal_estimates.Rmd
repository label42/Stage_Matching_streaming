...
ggsave("traitements_article_files/plot png/music_age.png", width = 18, height = 10, units = "cm", dpi = 300,
       bg = "white", device = "png")
```
...
ggsave("traitements_article_files/plot png/film_age.png", width = 18, height = 10, units = "cm", dpi = 300,
       bg = "white", device = "png")
```
...
ggsave("traitements_article_files/plot png/serie_age.png", width = 18, height = 10, units = "cm", dpi = 300,
       bg = "white", device = "png")
```

## size of treated, non-treated, and control groups
...
plot <- d_three_diff %>% 
  ...
  scale_color_manual(values=c("#1a9641", "#d7191c")) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0, colour = 'black', size = 14),
